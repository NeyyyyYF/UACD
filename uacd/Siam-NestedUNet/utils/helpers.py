...
from models.Models import Siam_NestedUNet_Conc, SNUNet_ECAM, SNUNet_ECAMp1, SNUNet_ECAMp2, SNUNet_ECAMp3
...
def load_model(opt, device):
    ...
    # model = SNUNet_ECAMp1(opt.num_channel, 2).to(device)
    model = SNUNet_ECAMp2(opt.num_channel, 2).to(device)
    # model = SNUNet_ECAMp3(opt.num_channel, 2).to(device)
