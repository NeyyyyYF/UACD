...
shuffle_AB=False
# pretrain=mit_b1.pth
pretrain=checkpoints/CD_ChangeFormerV6_my_S2LOOKING_b16_lr0.0001_adamw_train_test_60_linear_ce_multi_train_True_multi_infer_False_shuffle_AB_False_embed_dim_256/best_ckpt.pt
split=train
split_val=test
project_name=CD_${net_G}_${data_name}_b${batch_size}_lr${lr}_${optimizer}_${split}_${split_val}_${max_epochs}_${lr_policy}_${loss}_multi_train_${multi_scale_train}_multi_infer_${multi_scale_infer}_shuffle_AB_${shuffle_AB}_embed_dim_${embed_dim}
CUDA_VISIBLE_DEVICES=4 python main_cd.py \
...
# chmod +x scripts/run_rebuttal_s2looking2.sh
# scripts/run_rebuttal_s2looking2.sh
