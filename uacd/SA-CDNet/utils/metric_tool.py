...
class ConfuseMatrixMeter(AverageMeter):
    ...
    def update_cm(self, pr, gt, weight=1):
        """Obtain the current confusion matrix, calculate the current F1 score, and update the confusion matrix"""
...
def get_confuse_matrix(num_classes, label_gts, label_preds):
    """Calculate a set of predicted confusion matrices"""
...
def get_mIoU(num_classes, label_gts, label_preds):
    ...
    # print('acc: %.2f'%(100*score_dict['acc']))
    # print('mIoU: %.2f'%(100*score_dict['miou']))
    # print('mf1: %.2f'%(100*score_dict['mf1']))
    # print('F1_1: %.2f' % (100 * score_dict['F1_1']))
    # print('precision_0: %.2f' % (100 * score_dict['precision_0']))
    # print('precision_1: %.2f' % (100 * score_dict['precision_1']))
    # # print('precision: %.2f' % (100 * score_dict['mprecision']))
    return score_dict
